...
SYNONYM_MAP: Dict[str, List[str]] = {
    ...
    "detach": ["ayril", "ayrıl", "arka-plan", "detach", "disconnect", "ayrilmak"],
    "attach": ["baglan", "bağlan", "oturum", "session", "attach", "connect", "onceki", "önceki", "aktif", "baglanmak"],
    "baglan": ["attach", "connect", "baglan", "bağlan", "session", "oturum", "baglanmak"],
    "bağlan": ["attach", "connect", "baglan", "bağlan", "session", "oturum", "baglanmak"],
    "session": ["oturum", "session", "sessions", "aktif", "attach", "baglan", "bağlan", "surec"],
    "oturum": ["session", "sessions", "oturum", "aktif", "attach", "baglan", "bağlan", "surec"],
    "replace": ["degistir", "değiştir", "bul-degistir", "replace", "substitute"],
    "fold": ["katla", "katlama", "fold", "unfold", "kod-katla"],
    "macro": ["makro", "macro", "otomasyon", "kaydet"],

    # NvChad Ecosystem Tools & Plugins
    "telescope": ["telescope", "dosya-ara", "canli-arama", "live-grep", "fzf", "bul", "search", "picker"],
    "nvimtree": ["nvimtree", "nvim-tree", "dosya-agaci", "dosya-gezgini", "file-tree", "explorer", "tree", "sidebar"],
    "tree": ["nvimtree", "dosya-agaci", "dosya-gezgini", "file-tree", "explorer", "tree"],
    "explorer": ["nvimtree", "dosya-agaci", "dosya-gezgini", "file-tree", "explorer", "tree"],
    "lsp": ["lsp", "dil-sunucusu", "language-server", "tanim", "definition", "declaration", "hover", "signature", "rename", "refactor", "code-action", "diagnostic", "hata", "uyari"],
    "hover": ["hover", "dokumantasyon", "bilgi", "lsp", "aciklama"],
    "definition": ["definition", "tanim", "tanima-git", "kaynak", "lsp"],
    "tanim": ["definition", "tanim", "tanıma-git", "kaynak", "lsp"],
    "tanım": ["definition", "tanim", "tanıma-git", "kaynak", "lsp"],
    "declaration": ["declaration", "deklarasyon", "bildirim", "lsp"],
    "rename": ["rename", "yeniden-adlandir", "adlandir", "refactor", "degistir", "lsp"],
    "adlandir": ["rename", "yeniden-adlandir", "adlandir", "refactor", "degistir", "lsp"],
    "adlandır": ["rename", "yeniden-adlandir", "adlandir", "refactor", "degistir", "lsp"],
    "diagnostic": ["diagnostic", "hata", "uyari", "teshis", "problem", "loclist", "lsp"],
    "hata": ["diagnostic", "hata", "uyari", "teshis", "problem", "lsp"],
    "conform": ["conform", "formatter", "format", "bicimlendir", "duzenle", "prettier"],
    "format": ["format", "formatla", "bicimlendir", "biçimlendir", "duzenle", "conform", "prettier", "lsp"],
    "formatla": ["format", "formatla", "bicimlendir", "biçimlendir", "duzenle", "conform", "prettier", "lsp"],
    "gitsigns": ["gitsigns", "git", "hunk", "degisiklik", "blame", "preview", "fark"],
    "blame": ["blame", "git-blame", "satir-yazari", "kim-yazdi", "gitsigns"],
    "whichkey": ["whichkey", "which-key", "kisayol-listesi", "tus-rehberi", "keymaps"],
    "mason": ["mason", "lsp-kur", "linter", "formatter", "paket-yoneticisi", "package-manager"],
    "lazy": ["lazy", "eklenti", "plugin", "plugins", "paket", "plugin-manager"],
    "eklenti": ["lazy", "eklenti", "plugin", "plugins", "paket", "plugin-manager"],
    "plugin": ["lazy", "eklenti", "plugin", "plugins", "paket", "plugin-manager"],
    "treesitter": ["treesitter", "sozdizimi", "syntax", "renklendirme", "highlight", "ast"],
    "sozdizimi": ["treesitter", "sozdizimi", "sözdizimi", "syntax", "renklendirme", "highlight"],
    "sözdizimi": ["treesitter", "sozdizimi", "sözdizimi", "syntax", "renklendirme", "highlight"],
    "theme": ["tema", "theme", "renk", "base46", "dark", "light", "colorscheme"],
    "tema": ["tema", "theme", "renk", "base46", "dark", "light", "colorscheme"],
    "minty": ["minty", "color-picker", "renk-secici", "palet", "hex", "rgb", "shade"],
    "cheatsheet": ["cheatsheet", "rehber", "ipucu", "kisayollar", "nvcheatsheet"],
    "comment": ["yorum", "yoruma-al", "comment", "uncomment", "aciklama"],
    "yorum": ["comment", "yorum", "yoruma-al", "aciklama"],
    "term": ["terminal", "term", "konsol", "floating", "yuzen", "kabuk"],
    "terminal": ["terminal", "term", "konsol", "floating", "yuzen", "kabuk"],
